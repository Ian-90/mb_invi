...
$(document).ready(function() {
    ...
    // settings
	var $sliderDelay = 60000, // Delay between transitions (in ms).
                    ...
                    if(!$(this).hasClass("complete")){
                        ...
                        for (var i = 0; i < textArray.length; i++) {
                            if(textArray[i] == " "){
                                ...
                                textDone += '<div><span style="transition-delay: '+(i/30)+'s;">'+ '<sub><small style="color:#cacaca">故</small></sub>' +'</span></div>';
                            } else if(textArray[i] == "#"){
                                textDone += '<div><span style="transition-delay: '+(i/30)+'s;">'+ '<small>父</small>' +'</span></div>';
                            } else if(textArray[i] == "$"){
                                textDone += '<div><span style="transition-delay: '+(i/30)+'s;">'+ '<small>母</small>' +'</span></div>';
                            } else{
